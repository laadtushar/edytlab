...
use crate::commands::{
    ...
    list_providers, list_skills, list_templates, list_tracks, move_clip, open_project,
    prepare_compare, read_agent_profile, read_mcp_server, read_memory, read_skill, remove_clip,
    remove_marker, rename_node, render_preview, render_range, restart_mcp_server, send_message,
    set_active_agent_profile, set_active_model, set_active_provider, set_api_key, set_api_key_for,
    set_clip_envelope, set_head_to, set_selection_context, set_track_gain, set_track_muted,
