...
| [**tools-reference.md**](./tools-reference.md) | All 93 audio-editing tools the agent can call: what each one does and the parameters it takes. Generated from the registry. |
