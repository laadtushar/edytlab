...
const faqs = [
  ...
  },
  {
    ...
    a: "macOS 11 Big Sur or later on Apple Silicon, Windows 10/11, or Linux (.deb / AppImage). Intel Macs aren't covered by a published build yet. 8 GB RAM minimum, 16 GB recommended for stem separation. A GPU helps but isn't required — Metal on Mac and CUDA on Windows accelerate ML when available.",
  },
  {
    q: "Is it free?",
